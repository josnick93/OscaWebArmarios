            ...
            <ul class="nav navbar-nav navbar-right" style="border-left: 2px solid white">
                ...
                <li class="text-center">
                    <button class="btn btn-default" onclick="goBack()" style="margin:5px;margin-left:5px;height:60px">
                        <script>
                            function goBack() {
                                window.location.href="/OscaArmarios/TareaEntradaSeleccionTipoCajaNuevaUbi.html?lanzadera=${entablado.lanzadera.id_lanzadera}&articulo=${articulo.no}&cantidad=${cantidad}";
                            }
                        </script>
        ...
        $("#addMaterial").click(function() {
            if(Crear.msg=="Correct"){
                ...
                $.ajax({
                    ...
                    url: '/OscaArmarios/Operacion/TareaCrearUbicacionMedida',
                    ...
                    data: {entablado:'${entablado.codigo}' ,
                        ...
                        caja:TipoCaja ,xCoord:Crear.xCoord , yCoord:Crear.yCoord ,nfilas: parseInt(${filascaja})
                        , ncolumnas: parseInt(${columnascaja}),idTarea:${id_tarea},},
