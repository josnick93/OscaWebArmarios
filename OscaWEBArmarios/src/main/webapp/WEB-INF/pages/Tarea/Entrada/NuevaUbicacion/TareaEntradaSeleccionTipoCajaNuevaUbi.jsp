...
<div class="container" style="width: 100%;">
    <h3 class="text-left" style="margin-left: 20px;">NUEVA UBICACION - ENTRADA MANUAL</h3>
    <div class="row">
        <div class="col-sm-2">
    ...
    $(document).ready(function() {
        ...
        $("#botonUbicarMedida").click(function(){
            ...
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "TareaEntradaSeleccionNuevaUbicacionFinalMedida.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad})  +
                    ...
                    +$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&cerrar=${cerrar}&idTarea=${id_tarea}";
            }
        ...
        $(document).on('click', '.done', function () {
            ...
            if(${cerrar==1}){
                ...
                window.location.href = "TareaEntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+
                    tipoUbicacion.tipoCaja +"&entablado=PLNZ."+("00" + ${lanzadera.id_lanzadera}).slice(-2)+"."+("0000" + $('#text-basic').val()).slice(-4)+"&cerrar=0&idTarea=${id_tarea}";

            }
            else{
                window.location.href = "TareaEntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&entablado=PLNZ."+("00" + ${lanzadera.id_lanzadera}).slice(-2)+"."+("0000" + $('#text-basic').val()).slice(-4)+"&cerrar=-1&idTarea=${id_tarea}";
            }
            // }
        });
    });
