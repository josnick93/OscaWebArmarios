    ...
    $(document).ready(function() {
        ...
        $(function () {
            ...
            $("img[id=tipoCaja]").click(function() {
                ...
                if(${cerrar==1}){
                    window.location.href = "TareaEntradaSugerirUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera=${lanzadera.id_lanzadera}&cerrar=0&idTarea=${id_tarea}";
                }else{
                    window.location.href = "TareaEntradaSugerirUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera=${lanzadera.id_lanzadera}&idTarea=${id_tarea}";
                }
            });
        });
        ...
        $("#botonUbicarMedida").click(function(){
            ...
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "TareaEntradaSugerirUbicacionFinalMedida.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad})  +
                    "&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&cajafila="+$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&cerrar=${cerrar}&idTarea=${id_tarea}";
            }
