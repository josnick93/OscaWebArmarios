    ...
    $(document).ready(function() {
           ...
           //comprobar dimensiones
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "EntradaSeleccionNuevaUbicacionFinalMedida.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad})  +
                    "&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&entablado="+parseInt($('#medidaEntablado').val()) +"&cajafila="+$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&cerrar=${cerrar}";
            }
        ...
        $(document).on('click', '.done', function () {
            if((${articulo.peso*cantidad})>0.0){
                ...
                if(${cerrar==1}){
                    window.location.href = "EntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.articulo}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&entablado="+parseInt($('#text-basic').val())+"&cerrar=1";

                }
                else{
                    window.location.href = "EntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.articulo}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&entablado="+parseInt($('#text-basic').val());
                }
            }
        });
    });
