    ...
    <script>
        ...
        $("#anteriorUicacion").click(function() {
            if(nPosicion>=1){
                ...
                window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=${articulo.articulo}&cantidad=" +parseInt(${cantidad}) + "&caja="
                    +  ${TipoCaja.id_caja} +"&lanzadera=${lanzadera.id_lanzadera}&nsugerencia=${nsugerencia-1}&cerrar=${cerrar}";
                }
            }else{
        ...
        $("#siguienteUbicacion").click(function() {
            ...
            if(nPosicion==1){
                ...
                window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad}) + "&caja="
                    +  ${TipoCaja.id_caja} +"&lanzadera=${lanzadera.id_lanzadera}&nsugerencia=${1+nsugerencia}&cerrar=${cerrar}";
            }
