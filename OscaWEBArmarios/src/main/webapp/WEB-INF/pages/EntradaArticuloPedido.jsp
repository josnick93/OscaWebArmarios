...
<div class="container" style="width: 100%;">
    <div class="form-group form-group-sm">
        <h4>
            ...
            <span class="left"  style="float:left;">Nº LINEA ${articuloPedido.lineNo}</span>
        </h4>
    </div>
    </br>
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div id="entradaNoConfirmada" class="form-group form-group-sm">
                ...
                <span class="right" style="float:right;">
                   ...
                   <div id="PausarPedido" class="btn btn-default btn-lg" style='background:#009900;border-radius:0;color:white'>PAUSAR PEDIDO</div>
                </span>
                </h5>
            </div>
            <!--introducir cantidad-->
...
<script  type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#botonCantidadParcial").click( function () {
            //añadir material
            if($("#addCustomMaterial").css("backgroundColor")=="rgb(6, 169, 11)" && parseInt($('#entradaCantidadDivision').val()) > 0){
                alert("Iniciando llamada a funcion");
                $("#addCustomMaterial").modal('toggle');
                //marcar pedido y lanzar siguiente orden
                $.ajax({
                    type: 'GET',
                    contentType : 'application/json; charset=utf-8',
                    url: '/OscaArmarios/Operacion/AddMaterialPedidoDivision',
                        ...
                        if(data['res']=='true'){
                            ...
                            $.ajax({
                                ...
                                data: { orden:'LIBERAR', lanzadera:parseInt(${entablado.lanzadera.id_lanzadera}) ,
                                    entablado:parseInt(${entablado.codigo.substring(10)},10) , codigoAcesso:'${entablado.lanzadera.punto_acesso}'},
                                success:function () {
                                    window.location.href="/OscaArmarios/EntradaArticuloPedido.html?pedido=${articuloPedido.no}&cerrar=${cerrar}";
                                }
                            });
        ...
        $("#PausarPedido").click(function(){
            ...
            $.ajax({
                ...
                //lanzadera entablado x y articulo cantidad
                data: {lanzadera: ${entablado.lanzadera.id_lanzadera}, url: '/OscaArmarios/EntradaInfoPedido.html?pedido=${articuloPedido.no}' ,pedido: '${articuloPedido.no}', articulo: ${articuloPedido.itemNo}, accion: 5},
                dataType: 'json',
                async : true,
                success: function () {
                    $.ajax({
