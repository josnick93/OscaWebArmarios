...
<div class="text-left w-100 h-100 my-2 text-white py-5 text-uppercase">
    <div class="row">
        <div class="container" style="height:85%;text-left: center;margin-top:5%;margin-left:1%">
            <h1 class="my-3">SELECCIONAR ORDEN DE PRODUCCIÓN</h1>
            <form>
                <div class="form-group"> <label class="Lead">Código orden<input id="fomulario-articulo" type="text" class="form-control"></label> </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="label">Selección Orden</h4>
            </div>
        ...
        $("input").keypress(function(event) {
            if (event.which == 13) {
                ...
                $.ajax({
                    ...
                    url: '/OscaArmarios/SalidaBusquedaArticulo/ListarArticulos',
