    ...
    <div class="container" style="height:75%;text-align: center;margin-top:7%">
        <div class="row">
            <div class="col-md-6" style="height:50%">
                <a  id="salidaPedido" href="/OscaArmarios/SalidaSeleccionPedidoVenta.html?lanzadera=${lanzadera.id_lanzadera}" class="btn btn-primary btn-lg text-center my-5" style="margin-right: auto; margin-left: auto; width: 300px;background:#DD0000">SELECCIONAR PICKING</a>
            </div>
            <div class="col-md-6" style="height:50%">
                <a id="salidaManual" href="/OscaArmarios/SalidaBusquedaArticulo.html?lanzadera=${lanzadera.id_lanzadera}" class="btn btn-primary btn-lg text-center my-5"  style="margin-right: auto; margin-left: auto; width: 300px;background:#DD0000">SALIDA MANUAL</a>
            </div>
        </div>
    </div>
</div>
        ...
        $.ajax({
            ...
            success: function(data){
                if(jQuery.isEmptyObject(data)){
                    ...
                    $("#salidaPedido").attr("href","/OscaArmarios/SalidaSeleccionPedidoVenta.html?lanzadera="+data.id_lanzadera);
                    $("#salidaManual").attr("href","/OscaArmarios/SalidaBusquedaArticulo.html?lanzadera="+data.id_lanzadera);
