...
<div class="text-left w-100 h-100 my-2 text-white py-5 text-uppercase">
    <div class="row">
        <div class="container" style="height:85%;text-left: center;margin-top:5%;margin-left:1%">
            ...
            <form>
                <div class="form-group"> <label class="Lead">Código<input id="fomulario-articulo" type="text" class="form-control"></label> </div>
...
<div class="modal" id="DialogoMostrarArticulos" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer"> <a class="btn btn-primary" href="#DialogoMostrarArticulos" style="float: right;background:#DD0000;color: white;" data-dismiss="modal">Cerrar</a> </div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
            ...
            if (event.which == 13) {
                ...
                $.ajax({
                    ...
                    success: function(data,status){
                        ...
                        $('#DialogoMostrarArticulos').modal('toggle');
    ...
    function createTableByForLoop(data)
    {
        ...
        {
            eTable += "<tr  style=\"cursor: pointer\" onclick=\"location.href='/OscaArmarios/SalidaSeleccionUbicacion.html" +
