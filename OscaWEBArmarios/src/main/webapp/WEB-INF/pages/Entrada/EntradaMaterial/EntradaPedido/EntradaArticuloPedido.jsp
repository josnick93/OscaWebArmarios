...
<div class="container" style="width: 100%;">
    <div class="form-group form-group-sm">
        <h4>
            ...
            <span class="left"  style="float:left;">PEDIDO ${articuloPedido.no}</span>
        </h4>
    </div>
    </br>
    <div class="row">
        ...
        <div class="col-sm-10">
            <table class="table table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <td class="text-center">${articuloPedido.qtyOutstanding}</td>
                    <td class="text-center">${nLineasPedido}</td>
                </tr>
                </tbody>
            </table>
            ...
            <div id="entradaNoConfirmada" class="form-group form-group-sm">
                ...
                <span class="right" style="float:right;">
                    <div id="addCustomMaterial" class="btn btn-default btn-lg" style="background:#7d7d7d;border-radius:0;color:white">AÑADIR CANTIDAD MATERIAL</div>
    ...
    <div class="form-group form-group-sm">
        <h5>
            <span class="left" style="float:right;  margin-left: 0%;">
             			<div id="NuevaUbicacion"  class="btn btn-default btn-lg" style="background:#009900;border-radius:0;color:white;">CREAR NUEVA UBICACION</div>
            </span>
            <span class="left" style="float:right;  margin-left: 0%;">
            ...
            <span class="right" style="float:right;  margin-right: 2%;">
                  <div id="siguienteLinea"  class="btn btn-default btn-lg" style="background:#009900;border-radius:0;color:white;">SIGUIENTE UBICACIÓN</div>
            </span>
        </h5>
    </div>
</div>
...
<div id="finPedido" class="modal fade"  role="dialog" data-backdrop="static" data-keyboard="false"role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"> <strong>Instrucciones:</strong>
                <p/>
                <p>Ve a otra lanzadera/ubicacion para completar la entrada.</p>
            </div>
            <div class="modal-footer">
...
<script  type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#siguienteLinea").click(function() {
            window.location.href = "/OscaArmarios/EntradaArticuloPedido.html?pedido=${articuloPedido.no}&Nlinea=${articuloPedido.lineNo}&indiceLinea=${indiceLinea+1}";
        });

        $("#NuevaUbicacion").click(function() {
            window.location.href = "/OscaArmarios/EntradaPedidoArticuloTipoCajaNuevaUbi.html?articulo=${articuloPedido.itemNo}&pedido=${articuloPedido.no}&linea=${articuloPedido.lineNo}";
        });
        ...
        $("#Reubicar").click(function() {
            ...
            if($("#addCustomMaterial").css("backgroundColor")=="rgb(6, 169, 11)"){
                window.location.href = "/OscaArmarios/EntradaArticuloPedidoReubicarTipoCajaSugerirUbi.html?articulo=${articuloPedido.itemNo}&pedido=${articuloPedido.no}&linea=${articuloPedido.lineNo}&fila="+fila+"&columna="+columna;
            }else{
        ...
        $("#botonCantidad").click(function () {
            if(parseInt($('#entradaCantidad').val()) > 0) {
                $("#cantidadManip").replaceWith($('#entradaCantidad').val());
            }
        });
        ...
        $(".posicionArticulo").click(function(){
           ...
           $("#addMaterial").css('backgroundColor', '#06A90B');
            $("#addCustomMaterial").css('backgroundColor', '#06A90B');
            $("#Reubicar").css('backgroundColor', '#06A90B');
        });

        /**
         * Cantidad  Parcial
         *  $("#addCustomMaterial").modal('toggle');
         *  parseInt($('#entradaCantidadDivision').val())
         */
        //parseInt($('#entradaCantidadDivision').val())
        $("#botonCantidadParcial").click( function () {
            alert("Button pressend");
            //añadir material
            if(parseInt($('#entradaCantidadDivision').val()) > 0){
                $("#addCustomMaterial").modal('toggle');
                //marcar pedido y lanzar siguiente orden
                $.ajax({
                    type: 'GET',
                    contentType : 'application/json; charset=utf-8',
                    url: '/OscaArmarios/Operacion/AddCustomMaterialPedido',
                    ...
                    data: {
                        ...
                        fila:fila,
                        columna:columna,
                        cantidad:parseInt($('#entradaCantidadDivision').val())
                    },
                    dataType: 'json',
                    async : true,
                    success: function(data) {
                        ...
                        //line registered
                        if(data=="OK"){
                            window.location.href="/OscaArmarios/EntradaArticuloPedido.html?pedido=${articuloPedido.no}&cerrar=0";
                        }
                        //end lift lines
        ...
        $("#addMaterial").click(function() {
            ...
            if($(this).css("backgroundColor")=="rgb(6, 169, 11)"){
                ...
                $.ajax({
                    type: 'GET',
                    contentType : 'application/json; charset=utf-8',
                    url: '/OscaArmarios/Operacion/AddMaterialPedido',
                    //lanzadera entablado x y articulo cantidad
                    data: {
                        No:'${articuloPedido.no}',
                        Line_No:${articuloPedido.lineNo},
