    ...
    $(document).ready(function() {
        ...
        $(function () {
            ...
            $("img[id=tipoCaja]").click(function() {
                    ...
                    if(${cerrar==1}){
                        window.location.href = "EntradaArticuloPedidoReubicarSugerirUbicacionFinal.html?articulo=${articulo.no}&caja="+  tipoUbicacion.tipoCaja +"&cerrar=0&pedido=${pedido.no}&lineaPedido=${lineaPedido.lineNo}&fila=${fila}&columna=${columna}";
                    }else{
                        window.location.href = "EntradaArticuloPedidoReubicarSugerirUbicacionFinal.html?articulo=${articulo.no}&caja="+  tipoUbicacion.tipoCaja +"&cerrar=0&pedido=${pedido.no}&lineaPedido=${lineaPedido.lineNo}&fila=${fila}&columna=${columna}";
                    }
            });
