    ...
    $("#NuevaUbicacion").click(function() {
        ...
        if($('#nuevaCaja').css('border-style') == 'solid'){
            $.ajax({
                ...
                data: { pedido:'${pedido.no}' ,linea:parseInt(${lineaPedido.lineNo}),columnaOrigen:parseInt(${columna})
                    ,filaOrigen:parseInt(${fila}), lanzadera:parseInt(${lanzadera.id_lanzadera})
                    ,entablado:'${entablado.codigo}' ,
                    xPos:parseInt(fila) , yPos: parseInt(columna) ,
                    articulo:'${articulo.no}'
                    ,cantidad:parseFloat(${lineaPedido.qtyOutstanding}),
