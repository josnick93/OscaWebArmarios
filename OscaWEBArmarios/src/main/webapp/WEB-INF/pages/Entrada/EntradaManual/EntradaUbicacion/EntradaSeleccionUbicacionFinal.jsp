...
<!--Diagolo espera añadir material -->
            ...
            if($('#entradaArticulo').css('background-color') == 'rgb(0, 153, 0)'){
                $.ajax({
                    ...
                    data: {entablado:'${localizacionArticulo.entablado.codigo}' ,
                        fila:parseInt(${localizacionArticulo.fila}) , columna: parseInt(${localizacionArticulo.columna}) ,
                        articulo: '${localizacionArticulo.articulo}' , cantidad:parseFloat(${cantidad}), origen:'${origen}',
                       },
                    dataType: 'json',
                    async : true,
                    beforeSend: function()
