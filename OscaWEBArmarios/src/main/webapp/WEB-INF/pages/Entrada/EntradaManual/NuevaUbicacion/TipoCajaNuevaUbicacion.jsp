    ...
    $(document).ready(function() {
        ...
        $("#botonUbicarMedida").click(function(){
           //comprobar dimensiones
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "EntradaSeleccionNuevaUbicacionFinalMedida.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad})  +
                    ...
                    +$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&cerrar=${cerrar}&origen=${origen}";
            }
        ...
        $(document).on('click', '.done', function () {
           // if((${articulo.netWeight*cantidad})>0.0){
                ...
                if(${cerrar==1}){
                   // window.location.href = "EntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&entablado="+parseInt($('#text-basic').val())+"&cerrar=0";
                    window.location.href = "EntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+
                        tipoUbicacion.tipoCaja +"&entablado=PLNZ."+("00" + ${lanzadera.id_lanzadera}).slice(-2)+"."+("0000" + $('#text-basic').val()).slice(-4)+"&cerrar=0&origen=${origen}";

                }
                else{
                    window.location.href = "EntradaSeleccionNuevaUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&entablado=PLNZ."+("00" + ${lanzadera.id_lanzadera}).slice(-2)+"."+("0000" + $('#text-basic').val()).slice(-4)
                        +"&cerrar=-1&origen=${origen}";
                }
           // }
        });
    });
