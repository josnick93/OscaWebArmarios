...
<head>
    <title>Selección ubicació</title>
    <meta charset="utf-8">
            ...
            <ul class="nav navbar-nav navbar-right" style="border-left: 2px solid white">
                ...
                <li class="text-center">
                    <button class="btn btn-default" onclick="goBack()" style="margin:5px;margin-left:5px;height:60px">
                        <script>
                            function goBack() {
                                window.location.href="/OscaArmarios/EntradaSeleccionTipoCajaNuevaUbi.html?lanzadera=${entablado.lanzadera.id_lanzadera}&articulo=${articulo.no}&cantidad=${cantidad}&cerrar=${cerrar}";
                            }
                        </script>
...
<div id="traerEntabladoError" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Antes de selecionar una posicion debes traer el entablado y la caja</p>
            </div>
            <div class="modal-footer">
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data['RESULT '] == 'OK') {
                        ...
                        $('#entradaArticulo').css("border","10px solid #009900");
                    }
        ...
        $("#addMaterial").click(function() {
            if($('#entradaArticulo').css('background-color') == 'rgb(0, 153, 0)'){
                $.ajax({
                    type: 'GET',
                    contentType : 'application/json; charset=utf-8',
                    url: '/OscaArmarios/Operacion/addMaterialMedida',
