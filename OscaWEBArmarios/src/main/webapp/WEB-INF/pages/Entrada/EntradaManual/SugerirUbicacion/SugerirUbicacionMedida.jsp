...
<div id="esperarMaterial" class="modal fade"  role="dialog" data-backdrop="static" data-keyboard="false"role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
            ...
            if(nPosicion>=1){
                ...
                if( modoSubdivision==false && ${posiblesPosicionesSubdivision!=[]}){
                    ...
                    window.location.href = "EntradaSugerirUbicacionFinalMedida.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad})  +
                        "&lanzadera="+2+"&cajafila="+parseInt(${nFilasCaja})+"&cajacolumna="+parseInt(${nColumnasCaja})+"&nsugerencia="+parseInt(${nsugerencia-1})+"&origen=${origen}";
                }
            }else{
