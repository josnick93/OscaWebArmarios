    ...
    <script>
        ...
        $("#anteriorUicacion").click(function() {
            if(nPosicion>=1){
                ...
                window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="
                    +  ${TipoCaja.id_caja} +"&lanzadera=${lanzadera.id_lanzadera}&nsugerencia=${nsugerencia-1}&cerrar=${cerrar}&origen=${origen}";
                }
            }else{
        ...
        $("#siguienteUbicacion").click(function() {
            ...
            if(nPosicion==1){
                ...
                if(${posiblesPosiciones!=[]}){
                    ...
                    window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=${articulo.no}&cantidad=" +parseInt(${cantidad}) + "&caja="
                        +  ${TipoCaja.id_caja} +"&lanzadera=${lanzadera.id_lanzadera}&nsugerencia=${1+nsugerencia}&cerrar=${cerrar}&origen=${origen}";
                }
            ...
            if($('#nuevaCaja').css('border-style') == 'solid'){
                $.ajax({
                    ...
                    data: { lanzadera:parseInt(${lanzadera.id_lanzadera}) , entablado:'${entablado.codigo}' ,
                        ...
                        caja:parseInt(auxCaja) , xCoord: parseFloat(xCoord), yCoord:parseFloat(yCoord) , origen: '${origen}'
                    },
                    dataType: 'json',
                    async : true,
                    beforeSend: function()
