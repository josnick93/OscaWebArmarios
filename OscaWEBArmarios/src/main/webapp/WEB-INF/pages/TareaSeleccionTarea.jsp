    ...
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
                <p class="cabecera">TAREAS PENDIENTES</p>
            </a>
        </div>
            ...
            <table id="table"
                ...
                <c:if test="${!empty tareas}">
                    ...
                    <c:forEach items="${tareas}" var="tarea">
                        <tr class='clickable-row' style="cursor: pointer;" data-href='${tarea.URL}&idTarea=${tarea.idTareaPendiente}'>
