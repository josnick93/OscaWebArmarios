        ...
        <div class="col-sm-10">
            ...
            <div id="entradaNoConfirmada" class="form-group form-group-sm">
                ...
                <span class="left"  style="float:left;">
                   <div id="traerEntablado" class="btn btn-default btn-lg" style='background:#DD0000;border-radius:0;color:white'>EXTRAER ENTABLADO</div>
                </span>
                </h5>
            </div>
            <!--Introducir cantidad-->
                ...
                <c:forEach items="${ubicaciones}" var="ubicacion">
                    <c:choose>
                            <c:when  test="${ubicacion.tipoCaja.id_caja==1 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div  id='salidaArticulo' fila=${ubicacion.fila} fila2=${ubicacion.fila} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:11.5%;border:2px solid black;background:#dadada'><h5 class='desc'>
                            ...
                            <c:when test="${ubicacion.tipoCaja.id_caja==2 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div  id='salidaArticulo' fila=${ubicacion.fila} fila2=${ubicacion.fila-1} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:23%;border:2px solid black;background:#dadada'><h5 class='desc'>
                                        ${ubicacion.cantidad}</h5></div>
                            </c:when>
                            <c:when test="${ubicacion.tipoCaja.id_caja==3 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div  id='salidaArticulo' fila=${ubicacion.fila} fila2=${ubicacion.fila-1} columna=${ubicacion.columna} columna2=${ubicacion.columna+2} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:12.2%;height:23%;border:2px solid black;background:#dadada'><h2 class='desc'>
                            ...
                            <c:when test="${ubicacion.tipoCaja.id_caja==4 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila-3} columna=${ubicacion.columna} columna2=${ubicacion.columna+1} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:12.2%;height:46%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
                            ...
                            <c:when test="${ubicacion.tipoCaja.id_caja==6 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila-3} columna=${ubicacion.columna} columna2=${ubicacion.columna+3} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:24.4%;height:46%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
                            <c:when test="${ubicacion.tipoCaja.id_caja==7 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila-7} columna=${ubicacion.columna} columna2=${ubicacion.columna+3} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:24.4%;height:92%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
                            <c:when test="${ubicacion.tipoCaja.id_caja==8 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila-7} columna=${ubicacion.columna} columna2=${ubicacion.columna+7} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:48.8%;height:92%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
                            <c:when test="${ubicacion.tipoCaja.id_caja==9 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila-7} columna=${ubicacion.columna} columna2=${ubicacion.columna+15} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:97.6%;height:92%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
                            <c:when test="${ubicacion.tipoCaja.id_caja==10 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                ...
                                <div id='salidaArticulo' fila2=${ubicacion.fila}  fila=${ubicacion.fila+2} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos+23.1}%;left:+${ubicacion.xPos}%;width:6.1%;height:23%;border:2px solid black;background:#dadada'>
                            ...
                            <c:when test="${ubicacion.tipoCaja.id_caja==11 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                ...
                                <div id='salidaArticulo' fila=${ubicacion.fila}  fila2=${ubicacion.fila} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos+34.6}%;left:+${ubicacion.xPos}%;width:6.1%;height:11.5%;border:2px solid black;background:#dadada'>
...
<!-- Modal -->
<div id="/segEntabladoError" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal"  style="float: right;background:#DD0000;color: white;">CERRAR</button>
            </div>
        </div>
...
<div id="localizacionaddError" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Error al descontar material</h4>
            </div>
            <div class="modal-body">
                <p>No se ha podido descontar el material.</p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button>
            </div>
...
<div id="esperardescontarMaterial" class="modal fade"  role="dialog" data-backdrop="static" data-keyboard="false"role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
                <button type="button" class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title">Descontando material , por favor espere...</h4>
            </div>
            <div class="modal-body"> <strong>Instrucciones:</strong>
                <p/>
                <p>1- Espere a que se acabe de descontar el material</p>
...
<div class="modal fade" id="borrarCajaVacia" role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
            ...
            <div class="modal-footer">
                <button class="btn btn-success" id="aceptarBorrado" style="background:#DD0000">ACEPTAR</button>
                <a href="#" class="btn" data-dismiss="modal" style="background:#DD0000;color:white;margin-right: 2%">CERRAR</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data['RESULT '] == 'OK') {
                        ...
                        $('#salidaArticulo').css("border","10px solid #DD0000");
                    }
        ...
        $('#salidaArticulo').click(function (e) {
        ...
        $("#discountMaterial").click(function() {
            if($('#discountMaterial').css('background-color') == 'rgb(221, 0, 0)'){
                $.ajax({
                    type: 'GET',
                    ...
                    data: { entablado:'${localizacionArticulo.entablado.codigo}' , articulo:'${articulo.no}',
                        fila:parseInt(${localizacionArticulo.fila}) , columna: ${localizacionArticulo.columna}
                        , cantidad:parseFloat(${cantidad}) , destino: '${dest}'
                    },
                    dataType: 'json',
                    async : true,
                    beforeSend: function()
                    {
                        $('#esperardescontarMaterial').modal({
                            show: 'true'
                        });

                    },
                    success: function(data){
                         //Opcion de borrado de caja
                        if(${contenidoNav.quantity-cantidad==0}){
                              $('#borrarCajaVacia').modal("toggle");
                        }
                        ...
                        $( "#entradaManual" ).replaceWith(" <h4  class='text-left'>SALIDA MANUAL - MATERIAL DESONTADO</h4>");
                            ...
                            //$('.desc').text(${localizacionArticulo.cantidad-cantidad});
                        //liberar lanzadera
                        $.ajax({
                            url: 'http://${entablado.lanzadera.direccion_ip}:8080/ServidorArmarios/JSONServlet',
                            type: 'POST',
                            ...
                            ,success: function(data){
                                $('#esperardescontarMaterial').modal('toggle');
                            }
                        });
                    },
                    error: function(data) {
        ...
        $("#aceptarBorrado").click(function () {
            ...
            $.ajax({
                ...
                //lanzadera entablado x y articulo cantidad
                data: { entablado: '${localizacionArticulo.entablado.codigo}',
                    xPos: ${localizacionArticulo.fila}, yPos: ${localizacionArticulo.columna} ,
                },
                dataType: 'json',
                async : true,
                beforeSend: function()
