        ...
        <div class="navbar-collapse collapse" id="navbar">
            <ul class="nav navbar-nav navbar-right" style="border-left: 2px solid white">
                <li  style="border-right: 2px solid white">
                    <a href="/OscaArmarios/EntradaMaterialHome.html?lanzadera=${entablado.lanzadera.id_lanzadera}">
                        <p class="cabecera text-center">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon glyphicon-save"></span>&nbsp;&nbsp;Entrada&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
                    </a>
                </li>
                <li  style="border-right: 2px solid white" >
                    <a href="/OscaArmarios/ConsultaMaterialHome.html?lanzadera=${entablado.lanzadera.id_lanzadera}">
                ...
                <li class="active" style="border-right: 2px solid white">
                    <a href="/OscaArmarios/SalidaMaterialHome.html?lanzadera=${entablado.lanzadera.id_lanzadera}">
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if (data['RESULT '] == 'OK') {
                        ...
                        $('#entradaArticulo').css("border","10px solid #DD0000");
                    }
        ...
        $("#discountMaterial").click(function() {
            if($('#entradaArticulo').css('background-color') == 'rgb(221, 0, 0)'){
                        $.ajax({
                        type: 'GET',
                        contentType : 'application/json; charset=utf-8',
                        url: '/OscaArmarios/Operacion/dropCustomMaterial',
                        ...
                        data: { entablado:'${localizacionArticulo.entablado.codigo}' ,
                            ...
                            , articulo: '${articulo.no}' , cantidad:parseFloat(${cantidad}) ,origen:${origen}},
                        dataType: 'json',
                        async : true,
                        beforeSend: function()
                        {
        ...
        $("#aceptarBorrado").click(function () {
            ...
            $.ajax({
                ...
                //lanzadera entablado x y articulo cantidad
                data: { entablado: '${localizacionArticulo.entablado.codigo}',
                    xPos: ${localizacionArticulo.columna}, yPos: ${localizacionArticulo.fila} ,
                },
                dataType: 'json',
                async : true,
                beforeSend: function()
