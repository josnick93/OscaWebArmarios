        ...
        <div class="col-sm-10">
            <table class="table table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <td class="text-center" style="cursor:pointer">${nLineasRestantes}</td>
                </tr>
                </tbody>
            </table>
            <div id='entradaManual'>
                <h4  class="text-left">SALIDA PEDIDO</h4>
            </div>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="closeDeleteModal" href="/OscaArmarios/EntradaArticuloPedido.html?pedido=${articuloPedido.no}&cerrar=0" class="btn" data-dismiss="modal" style="background:#DD0000;color:white;margin-right: 2%">CERRAR</a>
            </div>
        </div>
    </div>
</div>
...
<script  type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#botonCantidadParcial").click( function () {
            //añadir material
            if(fila>0 && columna>0 && parseInt($('#entradaSalidaCantidadDivision').val()) > 0){
                $('#esperaSalidaMaterial').modal('toggle');
                ...
                $.ajax({
                    ...
                    url: '/OscaArmarios/Operacion/DiscountCustomMaterialPedido',
