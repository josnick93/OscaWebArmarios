...
<head>
            ...
            <div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav navbar-right" style="border-left: 2px solid white">
                    ...
                    <li class="active" style="border-right: 2px solid white">
                        <a class="active" href="/OscaArmarios/SalidaMaterialHome.html?lanzadera=${lanzadera.id_lanzadera}">
                            <p class="cabecera text-center ">&nbsp;&nbsp;&nbsp;<span
    ...
    <div class="container" style="width: 100%;">
        <h3 class="text-left" style="margin-left: 20px;">SALIDA MATERIAL</h3>
        <div class="row">
            <div class="col-sm-2">
            </div>
            <div class="col-sm-10">
                <table cellspacing="0" class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <th>
                            <font color="#fdfcfc">Fecha Estimada Recepcion</font>
                        </th>
                    </tr>
                    </thead>
                    <tbody>
                     ...
                     <span style="float: right;margin-right: 2%;margin-top:-25px">
                        <c:if test="${!empty lanzadera || !empty accesos}">
                          <form class="text-right">
                            <h3>
                              <a id="salida" class="btn btn-primary btn-lg outline px-3 mx-3 " data-toggle="modal">SALIDA PEDIDO</a>
                                 <a id="salidaAgrupada" class="btn btn-primary btn-lg outline px-3 mx-3 " data-toggle="modal">SALIDA PEDIDO AGRUPADO</a>
                            </h3>
                          </form>
                        </c:if>
                      </span>
        ...
        <div class="col-md-12 panel panel-default" style="margin-top:-50px">
            <h4 class="text-left">LISTADO ARTÍCULOS PEDIDO SALIDA</h4>
            ...
            <table class="table  table-condensed  table-responsive ">
                ...
                <tr>
                    ...
                    <th class="text-center" width="12%">
                        <font color="#fdfcfc">CANTIDAD SALIDA</font>
                    </th>
                </tr>
                </thead>
            </table>
                        ...
                        <c:if test="${!empty articulos_pedido}">
                            <c:forEach items="${articulos_pedido}" var="articulo">
                                <tr>
                                    ...
                                    <td class="text-center" width="12%">${articulo.qtyOutstanding}</td>
                                </tr>
                            </c:forEach>
                        </c:if>
                        </tbody>
                            ...
                            <c:forEach items="${articulos_pedido}" var="articulo">
                                <tr>
                                    ...
                                    <td class="text-center" style="width:5%">
                                        <a id='acceder' class="btn btn-primary btn-lg outline px-3 mx-3" data-toggle="modal" style='background:#DD0000'
                                           href='/OscaArmarios/SalidaArticuloPedido.html?pedido=${articulo.no}&Nlinea=${articulo.lineNo}'>
                                            SALIDA</a>
                                    </td>
                                </tr>
                            </c:forEach>
    ...
    <script>
        ...
        $(document).ready(function () {
            $("a[id=salida]").click(function () {
                ...
                window.location.href="/OscaArmarios/SalidaArticuloPedido.html?pedido=${pedido.no}";
            });
            $("a[id=salidaAgrupada]").click(function () {
                //distribuir tareas
                $('#esperarLanzarPicking').modal({
                    show: 'true'
                });
                window.location.href="/OscaArmarios/SalidaArticuloPedidoAgrupado.html?pedido=${pedido.no}";
            });
        });
    </script>
    <style type="text/css">
