...
<div class="container" style="width: 100%;">
    <div class="form-group form-group-sm">
        <h4>
            ...
            <span class="left"  style="float:left;">PICKING ${articuloPedido.no}</span>
        </h4>
    </div>
    </br>
    <div class="row">
        ...
        <div class="col-sm-10">
            ...
            <div id='entradaManual'>
                <h4  class="text-left">SALIDA PEDIDO AGRUPADO</h4>
            </div>
            ...
            <c:forEach items="${ubicaciones}" var="ubicacion">
                <c:choose>
                    <c:when test="${ubicacion.tipoCaja.id_caja==1}">
                        <c:choose>
                            <c:when test="${ubicacion.articulo.equals(articuloPedido.itemNo)}">
                                <div  fila=${ubicacion.fila} fila2=${ubicacion.fila} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap posicionArticulo" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:11.5%;border:8px solid #DD0000;background:#dadada;cursor:default'><h4 class='desc'>
                    ...
                    <c:when test="${ubicacion.tipoCaja.id_caja==2}">
                        <c:choose>
                            <c:when test="${ubicacion.articulo.equals(articuloPedido.itemNo)}">
                                <div  fila=${ubicacion.fila} fila2=${ubicacion.fila-1} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap posicionArticulo" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:23%;border:8px solid #DD0000;background:#dadada;cursor:default'><h4 class='desc'>
                                        ${ubicacion.cantidad}</h4></div>
                            </c:when>
                            <c:otherwise>
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Debes seleccionar una caja para poder descontar material.</p>
            </div>
...
<div id="esperaSalidaMaterial" class="modal fade"  role="dialog"  data-keyboard="false"role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
...
<div id="dialogoErrorRegistrarLinea" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body"> <strong>ERROR AL DESCONTAR MATERIAL</strong>
                <p/>
                <p>No se ha podido descontar el material o registrar el pedido.</p>
                <p>Revisa el estado del picking en NAV.</p>
            </div>
            <div class="modal-footer">
...
<div id="eliminarCajaVacia" class="modal fade"  role="dialog" data-keyboard="false"role="dialog">
    <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
            <div class="modal-header modal-header-danger">
    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a id="closeDeleteModal" href="/OscaArmarios/SalidaArticuloPedidoAgrupado.html?pedido=${articuloPedido.no}&cerrar=${cerrar}" target="_blank" class="btn" style="background:#DD0000;color:white;margin-right: 2%">CERRAR</a>
            </div>
        </div>
    </div>
</div>
...
<script  type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $("#closeDeleteModal").click(function () {
            ...
            window.location.href="/OscaArmarios/SalidaArticuloPedidoAgrupado.html?pedido=${articuloPedido.no}&cerrar=${cerrar}";
        });
           ...
           // if($(this).css("backgroundColor") == 'rgb(221,0, 0)'){
            if(fila > 0 && columna > 0){
                    ...
                    $.ajax({
                        ...
                        url: '/OscaArmarios/Operacion/DiscountMaterialPedidoAgrupado',
        ...
        $("#aceptarBorrado").click(function () {
            ...
            $.ajax({
                ...
                //lanzadera entablado x y articulo cantidad
                data: { entablado: '${articuloPedido.binCode}',
                    xPos: fila, yPos: columna ,
                },
                dataType: 'json',
                async : true,
                beforeSend: function()
