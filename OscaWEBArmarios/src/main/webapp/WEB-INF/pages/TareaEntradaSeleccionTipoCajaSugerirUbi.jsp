        ...
        $(function () {
            ...
            $("img[id=tipoCaja]").click(function() {
                ...
                window.location.href = "TareaEntradaSugerirUbicacionFinal.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad}) + "&caja="+
                    tipoUbicacion.tipoCaja +"&lanzadera="+2+"&idTarea=${id_tarea}";
            });
        });
        ...
        $("#botonUbicarMedida").click(function(){
            ...
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "EntradaSugerirUbicacionFinalMedida.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad})  +
                    "&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&cajafila="+$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&idTarea=${id_tarea}";
            }
