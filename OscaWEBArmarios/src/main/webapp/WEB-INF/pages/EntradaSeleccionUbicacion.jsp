    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="row w-50">
                    <div class="col-md-6">
                        <a class="btn btn-primary my-3 mx-0 btn-block text-center btn-lg" href="#myModal" data-toggle="">Introducir Peso</a>
                    </div>
                    <div class="col-md-6">
                        <h4 class="my-2 bg-warning px-2 py-3">Peso total:0,000 Kg.</h4>
                    </div>
                </div>
            </div>
            <table class="table table-striped custab">
                ...
                <tr>
                    ...
                    <td class="text-center bg-success">${cantidad}</td>
                </tr>
                </tbody>
            </table>
                    ...
                    <table id="example" class="table table-striped table-bordered nowrap" cellspacing="0" width="100%">
                        ...
                        <c:if test="${!empty ubicaciones}">
                            ...
                            <c:forEach items="${ubicaciones}" var="ubicacion">
                                <tr>
                                    <td>${ubicacion.lift}</td>
                                    <td>${ubicacion.shelf}</td>
                                    <td>${ubicacion.fila}</td>
                                    <td>${ubicacion.column}</td>
                                    <td>${ubicacion.cantidad}</td>
                                    <td>11</td>
                                    <td class="text-right">
                                        <a class="btn btn-primary" href="/OscaArmarios/EntradaSeleccionUbicacionFinal.html?articulo=${articulo.articulo}&lanzadera=${ubicacion.lift}&entablado=${ubicacion.shelf}&fila=${ubicacion.fila}&columna=${ubicacion.columna}&cantidad=${cantidad}" data-toggle="modal">ACCEDER</a>
                                    </td>
                                </tr>
                            </c:forEach>
                            </tbody>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="row">
                    <div class="col-md-6">
                        <a class="btn btn-primary my-3 mx-0 text-left btn-lg" href="/OscaArmarios/EntradaSeleccionUbicacionFinal.html" data-toggle="modal">Sugerir Ubicación</a>
                    </div>
                    <div class="col-md-6">
                        <a class="btn btn-primary my-3 mx-0 text-left btn-lg" href="/OscaArmarios/EntradaSeleccionTipoCajaNuevaUbi.html?articulo=${articulo.articulo}&cantidad=${cantidad}" data-toggle="modal">Nueva Ubicación</a>
                    </div>
                </div>
            </div>
