...
<div class="container" style="width: 100%;">
    <div class="form-group form-group-sm">
        <h4> <span class="right" style="float:right;">${entablado.codigo}</span> <span class="left" style="float:left;">ENTABLADO ${entablado.codigo}</span> </h4>
    </div>
    <br>
    <div class="row">
                    ...
                    <tbody>
                        <c:forEach items="${historico}" var="accion">
                            <tr>
                                ...
                                <td class="text-center">${accion.articulo}</td>
...
<script>
    ...
    $("#ultimoMes").click(function () {
        window.location.href = "ConsultaHistoricoEntablado.html?entablado=${entablado.codigo}&modo=1";
    });

    $("#ultimo3Meses").click(function () {
        window.location.href = "ConsultaHistoricoEntablado.html?entablado=${entablado.codigo}&modo=2";
    });

    $("#ultimoAño").click(function () {
        window.location.href = "ConsultaHistoricoEntablado.html?entablado=${entablado.codigo}&modo=3";
    });

    $("#Todos").click(function () {
        window.location.href = "ConsultaHistoricoEntablado.html?entablado=${entablado.codigo}&modo=4";
    });

    //historico
    $("#volverEntablado").click(function () {
        window.location.href = "ConsultaEntablado.html?entablado=${entablado.codigo}&modo=4";
    });
