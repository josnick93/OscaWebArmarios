    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="label">Selección Entablado</h4>
            </div>
        ...
        $("#buscar").click(function() {
            ...
            $.ajax({
                ...
                success: function(data,status) {
                    ...
                    var eTable="";
                    if(data.length==1){
                        window.location.href=  "/OscaArmarios/ConsultaEntablado.html?entablado="+ data[0]['code'];
                    }else {
                        for (var i = 0; i < data.length; i++) {
                            eTable += "<tr  style=\"cursor: pointer\" onclick=\"location.href='/OscaArmarios/ConsultaEntablado.html" +
                                "?entablado=" + data[i]['code'] + "'\">";
                            eTable += "<td>" + data[i]['code'] + "</td>";
                            eTable += "<td>" + data[i]['description'] + "</td>";
                            eTable += "</tr>";
                        }
                        $('#ShelfsTable').html(eTable);
                    }
                },
