                ...
                <c:forEach items="${ubicaciones}" var="ubicacion">
                    <c:choose>
                            <c:when  test="${ubicacion.tipoCaja.id_caja==1 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div  id='salidaArticulo' fila=${ubicacion.fila} fila2=${ubicacion.fila} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:11.5%;border:2px solid black;background:#dadada'><h2 class='desc'>
                            ...
                            <c:when test="${ubicacion.tipoCaja.id_caja==2 && ubicacion.fila==localizacionArticulo.fila && ubicacion.columna==localizacionArticulo.columna}">
                                <div  id='salidaArticulo' fila=${ubicacion.fila} fila2=${ubicacion.fila-1} columna=${ubicacion.columna} columna2=${ubicacion.columna} class="wrap cajaOcupada" style='margin-left:0.2%;top:${ubicacion.yPos}%;left:+${ubicacion.xPos}%;width:6.1%;height:23%;border:2px solid black;background:#dadada'><h2 class='desc'>
                                        ${ubicacion.cantidad}</h2></div>
                            </c:when>
...
<script>
    ...
    $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(result=== "{\"RESULT \":\"OK\"}"){
                        ...
                        Crear.msg="Correct";
                        $('#salidaArticulo').css("border-color","#DD0000");
        ...
        $("#discountMaterial").click(function() {
            if(Crear.msg=="Correct" && $('#discountMaterial').css('background-color') == 'rgb(221, 0, 0)'){
                        $.ajax({
                        type: 'GET',
                        ...
                        success: function(data){
                            ...
                            $("#entradaNoConfirmada").replaceWith("<h5><span class='right' style='float:right;'>" +
                                ...
                                "</span>" +
                                "<span class='left'  style='float:left;'>" +
                                "SALIDA CONFIRMADA DE ${cantidad} UDS EN LA UBICACION "+ ${localizacionArticulo.columna}+" , "+ ${localizacionArticulo.fila} +"</span></h5>");
