...
<div class="container" style="width: 100%;">
    ...
    <script>
        ...
        function dibujarEntablado() {
            $("#contenidoEntablado").after("<div id='nuevaCaja' class='wrap' style='margin-left:0.2%;top:" + yCoord + "%;left:" + xCoord + "%;width:${6.1*nColumnasCaja}%;height:${11.5*nFilasCaja}%;border:8px solid #00af00;background: #00af00;><h5 class='desc'></h5></div>");
        }
