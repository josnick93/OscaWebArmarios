    ...
    $(document).ready(function() {
        ...
        $(function () {
            ...
            $("img[id=tipoCaja]").click(function() {
                    ...
                    if(${cerrar==1}){
                        window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera=${lanzadera.id_lanzadera}&cerrar=1";
                    }else{
                        window.location.href = "EntradaSugerirUbicacionFinal.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad}) + "&caja="+  tipoUbicacion.tipoCaja +"&lanzadera=${lanzadera.id_lanzadera}";
                    }
            });
        });
        ...
        $("#botonUbicarMedida").click(function(){
           //comprobar dimensiones
            if($('#nfilas').val() <= 0 || $('#nfilas').val() >8 || $('#nfilas').val == 7
                ...
                window.location.href = "EntradaSugerirUbicacionFinalMedida.html?articulo=" + ${articulo.articulo} + "&cantidad=" +parseInt(${cantidad})  +
                    "&lanzadera="+parseInt(${lanzadera.id_lanzadera})+"&cajafila="+$('#nfilas').val()+"&cajacolumna="+$('#ncolumnas').val()+"&cerrar=${cerrar}";
            }
