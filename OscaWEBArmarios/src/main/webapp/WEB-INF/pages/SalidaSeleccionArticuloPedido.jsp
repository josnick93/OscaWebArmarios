            ...
            <div class="col-sm-10">
                <table class="table table-bordered table-responsive">
                    ...
                    <tr>
                        ...
                        <th>
                            <font color="#fdfcfc">LOCALIZACION</font>
                        </th>
                        <th>
                    ...
                    <tbody>
                    <tr>
                        <td class="m-0">${pedido}</td>
                        <td>${articulo.descripcion}</td>
                        <td>${articulo.peso} KG</td>
                    </tr>
                    </tbody>
                </table>
                <h4 class="text-left">SELECIONAR ARTÍCULO ENTRADA</h4>
                <div class="row">
                ...
                <table class="table table-condensed table-bordered">
                    ...
                    <c:if test="${!empty articulos_pedido}">
                        <c:forEach items="${articulos_pedido}" var="articulo">
                            <tr>
                                <td class="text-center">${articulo.itemNo}</td>
                                <td class="text-center">${articulo.lineNo}</td>
                                <td class="text-center">${articulo.description}</td>
                                <td class="text-center">${articulo.quantity}</td>
                                <td class="text-center">
                                    <a id='salida' class="btn btn-primary btn-lg outline px-3 mx-3" data-toggle="modal">ENTRADA</a>
                                </td>
                            </tr>
                        </c:forEach>
                    </c:if>
