 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/employee_ws}Employee_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<EmployeeWSFilter> filter;
     ...
     * {@link EmployeeWSFilter }
     * 
     * 
     */
    public List<EmployeeWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<EmployeeWSFilter>();
        }
        return this.filter;
    }
