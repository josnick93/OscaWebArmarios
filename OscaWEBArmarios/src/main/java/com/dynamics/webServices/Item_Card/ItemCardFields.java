...
/**
 * <p>Clase Java para Item_Card_Fields.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * <p>
 * <pre>
 * &lt;simpleType name="Item_Card_Fields">
 ...
 * 
 */
@XmlType(name = "Item_Card_Fields")
@XmlEnum
public enum ItemCardFields {
    ...
    public static ItemCardFields fromValue(String v) {
        for (ItemCardFields c: ItemCardFields.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
