 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/item_card}Item_Card_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ItemCardFilter> filter;
     ...
     * 
     */
    public List<ItemCardFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ItemCardFilter>();
        }
        return this.filter;
    }
