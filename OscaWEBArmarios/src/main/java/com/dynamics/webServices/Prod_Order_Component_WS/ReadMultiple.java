 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/prod_order_component_ws}Prod_Order_Component_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ProdOrderComponentWSFilter> filter;
     ...
     * {@link ProdOrderComponentWSFilter }
     * 
     * 
     */
    public List<ProdOrderComponentWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ProdOrderComponentWSFilter>();
        }
        return this.filter;
    }
