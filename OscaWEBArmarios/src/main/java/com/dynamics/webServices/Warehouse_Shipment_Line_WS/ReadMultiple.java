 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_shipment_line_ws}Warehouse_Shipment_Line_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseShipmentLineWSFilter> filter;
     ...
     * {@link WarehouseShipmentLineWSFilter }
     * 
     * 
     */
    public List<WarehouseShipmentLineWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseShipmentLineWSFilter>();
        }
        return this.filter;
    }
