 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/bin_content_ws}Bin_Content_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<BinContentWSFilter> filter;
     ...
     * {@link BinContentWSFilter }
     * 
     * 
     */
    public List<BinContentWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<BinContentWSFilter>();
        }
        return this.filter;
    }
