 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_receipt_line_ws}Warehouse_Receipt_Line_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseReceiptLineWSFilter> filter;
     ...
     * {@link WarehouseReceiptLineWSFilter }
     * 
     * 
     */
    public List<WarehouseReceiptLineWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseReceiptLineWSFilter>();
        }
        return this.filter;
    }
