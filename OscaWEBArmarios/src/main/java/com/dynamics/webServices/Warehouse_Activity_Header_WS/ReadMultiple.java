 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_activity_header_ws}Warehouse_Activity_Header_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseActivityHeaderWSFilter> filter;
     ...
     * {@link WarehouseActivityHeaderWSFilter }
     * 
     * 
     */
    public List<WarehouseActivityHeaderWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseActivityHeaderWSFilter>();
        }
        return this.filter;
    }
