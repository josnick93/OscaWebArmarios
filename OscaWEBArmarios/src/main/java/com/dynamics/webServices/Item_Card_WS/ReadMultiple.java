 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/item_card_ws}Item_Card_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ItemCardWSFilter> filter;
     ...
     * {@link ItemCardWSFilter }
     * 
     * 
     */
    public List<ItemCardWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ItemCardWSFilter>();
        }
        return this.filter;
    }
