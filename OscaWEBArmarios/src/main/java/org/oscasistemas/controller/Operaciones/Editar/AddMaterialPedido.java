...
public class AddMaterialPedido {
    ...
    String addMaterialPedido(HttpServletRequest request,
        ...
        if(!existenLineasSinMarcar(articulo, No, Bin_Code)) {
            ...
            WarehouseActivityLineWSList lineasPedidoSinMarcarT =  getOrigenesEnLanzadera(No);
    ...
    private WarehouseActivityLineWSList getOrigenesEnLanzadera(String No) throws  Exception{
