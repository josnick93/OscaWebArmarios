 ...
 */
@RestController
public class DiscountCustomMaterialPedido {
    ...
    @RequestMapping(value = "Operacion/DiscountCustomMaterialPedido", method = RequestMethod.GET)
    public @ResponseBody
    String discountCustomMaterialPedido(HttpServletRequest request,
        ...
        if (remoteAddr == null || "".equals(remoteAddr)) {
            ...
            try {
                ...
                SalidaUtils.salidaActuallizarCantidadManejar(No, Line_No,cantidad);
                //put line
                SalidaUtils.salidaActuallizarCantidadManejar(No, Line_No+10000,cantidad);
            }catch(SOAPFaultException ex){
                ex.printStackTrace();
                return "error:"+ex.getMessage();
            }
