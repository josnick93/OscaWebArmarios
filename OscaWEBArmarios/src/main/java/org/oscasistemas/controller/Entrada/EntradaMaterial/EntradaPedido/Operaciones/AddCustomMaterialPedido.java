 ...
 */
@RestController
public class AddCustomMaterialPedido {
    ...
    @RequestMapping(value = "Operacion/AddCustomMaterialPedido", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    @JsonView(View.SummaryWithRecipients.class)
    public @ResponseBody
    String addCustomMaterialPedido(HttpServletRequest request,
                             ...
                             @NotNull @RequestParam(value = "Item_No", required = true, defaultValue = "000000000") String articulo)
    {
        ...
        try {
            ...
            EntradaPedidoUtils.entradaActualizarCantidadAManipular(No, Line_No,cantidad);
            //update put line
            EntradaPedidoUtils.entradaActualizarCantidadAManipular(No, Line_No-10000,cantidad);
        }catch(SOAPFaultException ex){
            ex.printStackTrace();
            ex.getMessage();
        }
