 ...
 */
@RestController
public class AddMaterialMedida {
    ...
    @RequestMapping(value = "Operacion/addMaterialMedida", method = RequestMethod.GET)
    public @ResponseBody
    String addMaterialMedida(HttpServletRequest request,
        ...
        cajaEntabladoMedidaService.addOrUpdateCajaEntablado(c);
        //añadir al historico
