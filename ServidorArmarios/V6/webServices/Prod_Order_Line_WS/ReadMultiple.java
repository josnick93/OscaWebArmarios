 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/prod_order_line_ws}Prod_Order_Line_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<ProdOrderLineWSFilter> filter;
     ...
     * {@link ProdOrderLineWSFilter }
     * 
     * 
     */
    public List<ProdOrderLineWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<ProdOrderLineWSFilter>();
        }
        return this.filter;
    }
