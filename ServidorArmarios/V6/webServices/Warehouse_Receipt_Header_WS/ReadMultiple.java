 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_receipt_header_ws}Warehouse_Receipt_Header_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseReceiptHeaderWSFilter> filter;
     ...
     * {@link WarehouseReceiptHeaderWSFilter }
     * 
     * 
     */
    public List<WarehouseReceiptHeaderWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseReceiptHeaderWSFilter>();
        }
        return this.filter;
    }
