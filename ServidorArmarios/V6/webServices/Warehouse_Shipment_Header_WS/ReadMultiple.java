 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_shipment_header_ws}Warehouse_Shipment_Header_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseShipmentHeaderWSFilter> filter;
     ...
     * {@link WarehouseShipmentHeaderWSFilter }
     * 
     * 
     */
    public List<WarehouseShipmentHeaderWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseShipmentHeaderWSFilter>();
        }
        return this.filter;
    }
