 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/bin_ws}Bin_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<BinWSFilter> filter;
     ...
     * 
     */
    public List<BinWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<BinWSFilter>();
        }
        return this.filter;
    }
