 ...
 *       &lt;sequence>
 *         &lt;element name="filter" type="{urn:microsoft-dynamics-schemas/page/warehouse_activity_line_ws}Warehouse_Activity_Line_WS_Filter" maxOccurs="unbounded"/>
...
public class ReadMultiple {
    ...
    protected List<WarehouseActivityLineWSFilter> filter;
     ...
     * {@link WarehouseActivityLineWSFilter }
     * 
     * 
     */
    public List<WarehouseActivityLineWSFilter> getFilter() {
        if (filter == null) {
            filter = new ArrayList<WarehouseActivityLineWSFilter>();
        }
        return this.filter;
    }
